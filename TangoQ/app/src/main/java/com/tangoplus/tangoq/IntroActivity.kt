...
class IntroActivity : AppCompatActivity() {
    ...
    private val intervalTime = 2500.toLong()
...
//                        fetchUserSELECTJson(getString(com.tangoplus.tangoq.R.string.IP_ADDRESS_t_user), encodedUserMobile) { jsonObj ->
...
////                                    PersonalSetupInit() TODO 경로 설정
//                                }
//                            } else {
//                                fetchUserUPDATEJson(getString(com.tangoplus.tangoq.R.string.IP_ADDRESS_t_user), JsonObj.toString(), encodedUserMobile) {
//                                    if (jsonObj != null) {
//                                        StoreUserInSingleton(this@IntroActivity, jsonObj)
//                                    }
//                                    Log.e("네이버>싱글톤", "${Singleton_t_user.getInstance(this@IntroActivity).jsonObject}")
...
//                                        fetchUserINSERTJson(getString(com.tangoplus.tangoq.R.string.IP_ADDRESS_t_user), JsonObj.toString()) {
//                                            StoreUserInSingleton(this@IntroActivity, JsonObj)
//                                            Log.e("카카오>싱글톤", "${Singleton_t_user.getInstance(this@IntroActivity).jsonObject}")
////                                            PersonalSetupInit() TODO 경로 설정
//                                        }
//                                    } else {
//                                        fetchUserUPDATEJson(getString(com.tangoplus.tangoq.R.string.IP_ADDRESS_t_user), JsonObj.toString(), encodedUserMobile) {
...
//                    .requestIdToken(getString(com.tangoplus.tangoq.R.string.firebase_client_id))
//                    .requestEmail()
//                    .build()
...
//            NaverIdLoginSDK.oauthLoginCallback = oauthLoginCallback
//        } // -----! 네이버 로그인 버튼 끝 !-----
